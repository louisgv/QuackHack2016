...
public class TileGrid : MonoBehaviour {
    ...
    [SerializeField] private Sprite road_sprite;
    ...
    private void setSprite(Tile tile, eTerrain terrain)
    {
        switch (terrain)
        {
            case (eTerrain.open): tile.sprite.sprite = open_sprite; return;
            case (eTerrain.road): tile.sprite.sprite = road_sprite; return;
        }
    }
